(custom-set-variables
 ...
 '(package-selected-packages
   '(agent-shell aidermacs ample-theme bash-completion
                 color-theme-sanityinc-tomorrow command-log-mode company
                 company-lsp crm-custom crontab-mode deadgrep diff-hl
                 dockerfile-mode doom-modeline dpkg-dev-el emojify erc-hl-nicks
                 expand-region flx-ido flycheck forge git-commit go-mode
                 go-projectile graphql-mode groovy-mode hcl-mode
                 ...
                 rust-mode scratch scss-mode smartparens smex terraform-mode
